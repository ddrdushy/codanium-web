...
export async function pushProjectToGitHub(options: PushOptions): Promise<PushResult> {
  ...
  if (shouldCreatePR) {
    const title = prTitle ?? `Codanium: ${commitMessage}`;
...
function buildPRBody(
  ...
  let body = `## Codanium Delivery\n\n`;
  body += `**Project**: ${projectName}\n`;
  body += `**Code Files**: ${artifacts.length}\n`;
  body += `**Documents**: ${docCount}\n`;
  body += `**Generated by**: Codanium agents\n\n`;
  body += `### Files by Agent\n\n`;
  ...
  body += `---\n`;
  body += `*This PR was automatically created by [Codanium](https://aiteamstudio.com).*\n`;
